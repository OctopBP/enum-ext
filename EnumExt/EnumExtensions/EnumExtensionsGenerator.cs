...
public sealed class EnumExtensionsGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        {
            i.AddSource(hintName: "ConversionStrategyEnum.g", ConversionStrategyEnum.EnumText);
            i.AddSource(
    ...
    )
    {
        ...
        {
            if (ctx.SemanticModel.GetDeclaredSymbol(enumMemberDeclarationSyntax, token) is not IFieldSymbol
                enumMemberSymbol)
            {
                continue;
            }
    ...
    private static string GenerateCode(EnumToProcess enumToProcess)
    {
        ...
        {
            builder.Append(
                Utils.GeneratedEnumByAttributeSummary(EnumExtensionsAttribute.AttributeFullName, enumFullName));
        ...
        void AppendEnumName()
        {
            builder.AppendIdent().Append("public const string EnumName = \"").Append(enumName).Append("\";")
                .AppendLine();
        ...
        void AppendValues()
        {
            builder.AppendIdent().Append("public static ").Append(enumFullName).Append("[] Values => new[]")
                .AppendLine();
