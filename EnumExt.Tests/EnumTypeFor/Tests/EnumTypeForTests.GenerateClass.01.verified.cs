//HintName: ClassWithIntForColorTest.g.cs
/// <auto-generated />
...
/// </summary>
[System.Serializable]
public class ClassWithIntForColorTest
{
    ...
    public Test.ClassWithInt GetRed => Red;
    public Test.ClassWithInt GetBlue => Blue;
    public Test.ClassWithInt GetGreen => Green;

    public ClassWithIntForColorTest() { }

    public ClassWithIntForColorTest(Test.ClassWithInt red, Test.ClassWithInt blue, Test.ClassWithInt green)
    {
        this.Red = red;
        this.Blue = blue;
        this.Green = green;
    ...
    public System.Collections.Generic.Dictionary<ColorTest, Test.ClassWithInt>  Dict => new System.Collections.Generic.Dictionary<ColorTest, Test.ClassWithInt>()
    {
        { ColorTest.Red, Red },
        { ColorTest.Blue, Blue },
        { ColorTest.Green, Green },
